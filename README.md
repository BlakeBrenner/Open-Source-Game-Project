...
### Upgrade Shop
The shop appears at fixed height intervals (for example, every 1000 units climbed) or when landing on a shop platform.
...
Shop features:
- Navigation uses left and right input.
- Jump is used to select and purchase options.
...
4. Run `Main.tscn` as the main scene  
